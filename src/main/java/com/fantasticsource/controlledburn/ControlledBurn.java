...
@Mod(modid = ControlledBurn.MODID, name = ControlledBurn.NAME, version = ControlledBurn.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.068,)", acceptableRemoteVersions = "*")
public class ControlledBurn
{
    ...
    public static final String VERSION = "1.12.2.023";
